...
#define gmn gmn_kdr
 double gmn = 0.7;
#define ninf_kdr _thread1data[0]
#define ninf _thread[_gth]._pval[0]
#define nmax nmax_kdr
 double nmax = 2;
#define q10 q10_kdr
 double q10 = 1;
#define taun_kdr _thread1data[1]
#define taun _thread[_gth]._pval[1]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 kdr /home/alex/Dropbox/notebooks/Williams_etal_2015/h_current/x86_64/kdrca1.mod\n");
