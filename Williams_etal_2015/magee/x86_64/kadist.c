...
#define gmn gmn_kad
 double gmn = 0.39;
#define linf_kad _thread1data[0]
#define linf _thread[_gth]._pval[0]
#define lmin lmin_kad
 double lmin = 2;
#define ninf_kad _thread1data[1]
...
#define qq qq_kad
 double qq = 5;
#define taun_kad _thread1data[2]
#define taun _thread[_gth]._pval[2]
#define taul_kad _thread1data[3]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 kad /home/alex/Dropbox/notebooks/Williams_etal_2015/h_current/x86_64/kadist.mod\n");
