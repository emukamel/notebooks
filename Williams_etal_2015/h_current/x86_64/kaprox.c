...
#define gmn gmn_kap
 double gmn = 0.55;
#define linf_kap _thread1data[0]
#define linf _thread[_gth]._pval[0]
#define lmin lmin_kap
 double lmin = 2;
#define ninf_kap _thread1data[1]
#define ninf _thread[_gth]._pval[1]
...
#define qq qq_kap
 double qq = 5;
#define taun_kap _thread1data[2]
#define taun _thread[_gth]._pval[2]
#define taul_kap _thread1data[3]
#define taul _thread[_gth]._pval[3]
#define tq tq_kap
 double tq = -40;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 kap /home/alex/Dropbox/notebooks/Williams_etal_2015/h_current/x86_64/kaprox.mod\n");
