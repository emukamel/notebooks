...
#define gmt gmt_km
 double gmt = 0.4;
#define inf_km _thread1data[0]
#define inf _thread[_gth]._pval[0]
#define kl kl_km
 double kl = -10;
#define q10 q10_km
 double q10 = 5;
#define st st_km
 double st = 1;
#define tau_km _thread1data[1]
#define tau _thread[_gth]._pval[1]
#define vhalft vhalft_km
 double vhalft = -42;
#define vhalfl vhalfl_km
 double vhalfl = -40;
#define zetat zetat_km
 double zetat = 7;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 km /home/alex/Dropbox/notebooks/Williams_etal_2015/h_current/x86_64/km.mod\n");
