...
#define hmin hmin_nax
 double hmin = 0.5;
#define htau_nax _thread1data[0]
#define htau _thread[_gth]._pval[0]
#define hinf_nax _thread1data[1]
#define hinf _thread[_gth]._pval[1]
#define mmin mmin_nax
 double mmin = 0.02;
#define mtau_nax _thread1data[2]
#define mtau _thread[_gth]._pval[2]
#define minf_nax _thread1data[3]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 nax /home/alex/Dropbox/notebooks/Williams_etal_2015/h_current/x86_64/naxn.mod\n");
